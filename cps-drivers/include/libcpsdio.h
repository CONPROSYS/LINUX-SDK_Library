...
#define	DIO_ERR_PTR_DEVICE_NAME					10007		///< DeviceNameのポインタがNULLです
#define	DIO_ERR_PTR_DEVICE						10008		///< DeviceのポインタがNULLです
#define	DIO_ERR_UNKNOWN_DEVICE					10013		///< デバイスの種類を判別できません
#define	DIO_ERR_PTR_DEVICE_TYPE					10015		///< DeviceTypeのポインタがNULLです
